...
<div class="navbar">
 <h1 style=" text-align : center; color: white">Issues Status Report</h1>
</div>
...
$query = "SELECT issueStatus, count(*) as statusCount FROM reported_issues GROUP BY issueStatus;";
...
<div class="navbar" style="text-align: center">
  ...
  <a href="manageUsers.php"><i class="fa fa-fw fa-user"></i>Manage Users</a>
</div>
