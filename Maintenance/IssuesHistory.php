 ...
 <!-- I needed space here-->
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    	...
    	<a style="font-size: 18px" >Welcome: &nbsp;&nbsp; <strong style="text-transform: capitalize" ><?php echo $_SESSION['username']; ?></strong></a>&nbsp;&nbsp;&nbsp;&nbsp;
    	 <a href="\ITcapstone\index.php?logout='1'"  style="font-size: 18px; color: red">logout</a></b>
    <?php endif ?>
...
<button style="background: Red; float: right" type="button" class="btn" name="cancel" value="cancel" onClick="window.location='dashboardMaintenance.php';" />Exit</button>
