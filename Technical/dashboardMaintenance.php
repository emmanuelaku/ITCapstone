...
<nav>
  <ul class="nav">
	...
	<li><a class="active" href="DashboardMaintenance.php">Dashboard Maintenance</a></li>
 ...
 <!-- Part of user login display name cont. -->
 	<a href="\ITcapstone\index.php?logout='1'"  style="font-size: 18px; color: red; float: right; margin-right: 10px;">logout</a>
...
<div class="navbar">
 <h1 style=" text-align : center; color: white">Maintenance Issues Status Report</h1>
</div>
...
$query = "SELECT issueStatus, count(*) as statusCount FROM reported_issues WHERE issuesCategory = 'Maintenance' GROUP BY issueStatus;";
